...
const PROPERTIES = [
  ...
  {
   id: 'hari-bagh',
    name: 'Hari Bagh Farmhouse | Pet-friendly Organic Farm With Art Nook, Pond & Gaming Room',
    type: 'Farm House',
    address: 'Devgaon, Jaipur',
    location: 'Jaipur',
    state: 'Rajasthan',
    guests: 10, beds: 4, baths: 4, rating: 4.8,
    price: 22827, currency: '₹',
    featured: true,
    // badge: 'Lakefront',
    amenities: ['Chef on Call','Dining Table','Airconditioning','Caretaker','Wi-Fi','AC','Hygiene kit','Parking','Gaming room'],
    description: 'Nestled in Jaipur, this 4-BHK pet-friendly villa, built using rammed earth, combines zero-carbon sustainability with elegant design. Spanning an 8-acre organic farm, it offers unique spaces like an art nook with paintings & instruments, a sunken veranda, & a lush garden with bonfire seating. Enjoy a vibrant gaming zone, a lounge, a living area with exposed stone, and a pond with ducks. With bedrooms featuring skylights, & one offering a bathtub & patio, experience 5-star service embracing Atithi Devo Bhava.',
    images: [
      'hari-bagh/1.webp',
      'hari-bagh/2.webp',
      'hari-bagh/3.webp',
