...
const PROPERTIES = [
  ...
  },
  {
    ...
    images: [
      'farmhouse/assets/villa-images/Gold Palm Granola/1.webp',
      'farmhouse/assets/villa-images/Gold Palm Granola/2.webp',
      'farmhouse/assets/villa-images/Gold Palm Granola/3.webp',
      'farmhouse/assets/villa-images/Gold Palm Granola/4.webp',
      'farmhouse/assets/villa-images/Gold Palm Granola/5.webp',
      'farmhouse/assets/villa-images/Gold Palm Granola/6.webp',
      'farmhouse/assets/villa-images/Gold Palm Granola/7.webp',
      'farmhouse/assets/villa-images/Gold Palm Granola/8.webp',
      'farmhouse/assets/villa-images/Gold Palm Granola/9.webp',
    ]
  },
  {
    id: 'golden-acres',
    name: 'The Golden Acres',
    type: 'Farmhouse',
    location: 'Jaipur',
    state: 'Rajasthan',
    guests: 400, beds: 12, baths: 14, rating: 4.8,
    price: 120000,
    featured: true,
    badge: 'Wedding Venue',
    amenities: ['Lawn / Garden','Pool','Chef','Sound System','Parking','Bonfire','AC','Caretaker'],
    description: 'A sprawling 6-acre farmhouse on the Jaipur–Delhi highway designed for grand weddings and corporate galas. Hosts up to 400 guests across two manicured lawns.',
    images: [
